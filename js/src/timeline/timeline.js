...
links.Timeline.prototype.setOptions = function (options)
{
  if (options)
  {
    ...
    if (options.showButtonAdd != undefined)
    {
      ...
      if (console) { console.log('WARNING: Option showButtonAdd is deprecated. Use showButtonNew instead'); }
    }
    if (options.intervalMin != undefined)
    {
      this.options.zoomMin = options.intervalMin;
      if (console) { console.log('WARNING: Option intervalMin is deprecated. Use zoomMin instead'); }
    }
    if (options.intervalMax != undefined)
    {
      this.options.zoomMax = options.intervalMax;
      if (console) { console.log('WARNING: Option intervalMax is deprecated. Use zoomMax instead'); }
    }
...
links.Timeline.prototype.createItem = function (itemData)
{
  ...
  if (console) { console.log('ERROR: Unknown event style "' + type + '"'); };
